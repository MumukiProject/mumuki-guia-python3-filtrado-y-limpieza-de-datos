Para obtener los árboles de Palermo vas a tener que comparar la columna `neighbourhood` con ese string. No te olvides de escribir el `DataFrame` antes de los corchetes y dentro de ellos.
